        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                <form role="form" method="POST" action="{{ route('staff.store') }}">
                    ...
                    <div class="form-group row">
                        <label for="role" class="col-md-4 col-form-label text-md-right">{{ __('入职日期(校外老师不需要入职日期)') }}</label>
                        <div class="col-md-6">                            
                    ...
                    <div class="form-group row">
                        <label for="role" class="col-md-4 col-form-label text-md-right">{{ __('底薪') }}</label>
                        <div class="col-md-6">                            
